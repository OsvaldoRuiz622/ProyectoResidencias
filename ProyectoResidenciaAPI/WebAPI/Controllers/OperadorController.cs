...
namespace WebApi.Controllers
{
    ...
    public class OperadorController : ControllerBase
    {
        ...
        public IActionResult InsertarOperador([FromBody] Operador operador)
        {
            try
            {
                if (operadorDAO.Insertar(operador.Usuario, operador.Contrasena, operador.Cargo))
                {
        ...
        public IActionResult ActualizarOperador(int id, [FromBody] Operador operador)
        {
            try
            {
                if (operadorDAO.Actualizar(id, operador.Usuario, operador.Contrasena, operador.Cargo))
                {
